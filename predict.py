...
class Pred_vid(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/home/zsc/two_stream_net/logs/loss_2024_09_05_16_44_39/best_epoch_weights.pth',
...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        img = '/home/zsc/two_stream_net/pos_vis/4.bmp'
        try:
            ...
            #r_image.save("/home/zsc/TATN/vis/pred/DAUB/TATN/TATN_11_400.jpg")
            print("Detect finish.")
    elif mode == "video":
        import numpy as np
